...
10 DIM S,X,Y,C$,P,P(7,7),G(7,7),S(7,7),M,L
...
225 GOTO 200
230 S=132:GOSUB300:?@0,"CHECKING...":GOSUB650
240 IF W=1 THEN ?"WINNER!":STOP ELSE W=0:?@0,"           "
...
805 PRINT@480,"PLEASE WAIT";:GOSUB9700
810 G(1,4)=1:G(2,4)=1:G(3,4)=1:G(7,4)=0
885 PRINT@480,"           ";
890 RETURN
