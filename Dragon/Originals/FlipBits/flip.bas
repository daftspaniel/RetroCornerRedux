...
210 C=VAL(A$):IF C>0 AND C<8 THEN GOSUB450:GOTO230
215 R=ASC(A$):IF R>64 AND R<72 THEN R=R-64:GOSUB400:GOTO230
220 IF R=82 THEN GOSUB700:GOTO230
225 GOTO 200
230 M=M+1:S=132:GOSUB300:?@480,"checking...";:GOSUB1000:GOSUB650
240 IF W=1 THEN T$="well"+CHR$(128)+"done":TL=15:GOSUB9600:GOSUB9700:LE=LE+1:M=0:GOSUB1000:GOTO170
250 W=0:?@480,STRING$(11,CHR$(128));
...
1010 PRINT@448,"level"+STR$(LE);:?@453,CHR$(128);
1020 PRINT@464,"moves"+STR$(M);:?@469,CHR$(128);
1090 RETURN
