...
280 RETURN
290 REM BURN
300 SCREEN1,0:PLAY"T255AEAEAAAAEEA":SCREEN1,1:M=M-1:IFM>0THENGOSUB600
310 GOSUB562:GOSUB400
320 RETURN
330 REM SCORE
340 M(X,Y)=0:S=S+10+X:GOSUB520:PLAY"T255BCD"
350 RETURN
360 REM PORTAL AND NEXT LEVEL
370 L=L+1:PLAY"T30ACEG":GOSUB562
380 GOSUB550:GOSUB610:PUT(0,H(R))-(15,H(R)+15),P,PSET
390 RETURN
...
560 RETURN
561 REM CLEAR PLAYFIELD
562 LINE(0,96)-(255,192),PRESET,BF
563 LINE(0,16)-(255,96),PRESET,BF
569 RETURN
570 REM INIT GAME
580 L=1:S=0:M=3
590 RETURN
