...
290 RETURN
300 REM SCORE
310 M(X,Y)=0:S=S+10+X:GOSUB490:PLAY"T255BCDGG":GOSUB240
320 RETURN
...
830 HP=87:VP=40:O$="CASH@GRAB":GOSUB1050:PLAY"T255AO3AO2GG"
...
920 PCLS:LINE(0,176)-(255,176),PSET:LINE(0,15)-(255,15),PSET
