...
190 ON M(X,Y) GOSUB290,320,350:IF M THEN100
200 GOSUB960:GOTO50
...
270 RETURN
280 REM BURN
290 SCREEN1,0:PLAY"T255AEAEAAAAEEA":SCREEN1,1:M=M-1:IF M THENGOSUB540:GOSUB390:GOSUB650ELSEGOTO300
300 RETURN
310 REM SCORE
...
660 GOSUB710
670 IFL>2THENI=L+2:FORJ=1TOI:O=RND(16):R=RND(11):M(O,R)=1:PUT(H(O),H(R))-(H(O)+15,H(R)+15),R,PSET:SOUND255,1:NEXT
