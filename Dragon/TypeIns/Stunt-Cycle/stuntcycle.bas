...
240 IF L<210 THEN 215 ELSE BUS=0: GOTO
245 REM WHEELIES
250 V=8
...
355 IF BUS=0 THEN PUT (230, L)-(253, L+17), T, PSET: FOR PS=1 TO 500: NEXT PS 
360 GOSUB 135 
365 GOTO 200
...
380 BUS=0: GOSUB 135
385 GOTO 200
390 PUT ( 232, L)-(255, L+15), T, PSET: BUS=0: PUT (23 2,L)-(255, L+15), U, PSET: GOTO 200
