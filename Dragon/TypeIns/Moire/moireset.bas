...
20 GOSUB2000:CLS0: POKE 65495,0:PRINT"PLEASE WAIT";
30 QY=-1
...
120 IF L(QX,QY)*C AND 2 THEN SET(X+31,Y+15,D)
130 NEXT:NEXT:GOTO 80

2000 CLS0:TT$="MOIRE PATTERNS":TBY$="JOSIP KALEBIC":TD$="BASIC PROGRAMMING FB GROUP"
2010 TV$="PORTED FROM THE C64":TC$=CHR$(159):GOSUB 9010
